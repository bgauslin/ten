...
/**
 * Vanilla custom element that adds/removes a 'touch' class on touch targets in
 * the DOM for applying CSS.
 */	
customElements.define('ten-touch', class extends HTMLElement {
